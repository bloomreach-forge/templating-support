...
public class ThymeleafHstWebfilesAttribute extends BaseAttributeProcessor {

    private static final String ATTR_NAME = "webFile";

    public ThymeleafHstWebfilesAttribute(final String dialectPrefix) {
