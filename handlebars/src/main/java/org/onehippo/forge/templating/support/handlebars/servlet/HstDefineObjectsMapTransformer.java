...
class HstDefineObjectsMapTransformer implements Transformer {
    ...
    HstDefineObjectsMapTransformer(final HttpServletRequest request, final HttpServletResponse response) {
