...
public class PebbleHstActionURLNode implements RenderableNode {
    private static final Logger log = LoggerFactory.getLogger(PebbleHstActionURLNode.class);
    private final int lineNumber;
    private final String value;



    public PebbleHstActionURLNode(final int lineNumber, final String value) {
    ...
    public void render(final PebbleTemplateImpl self, final Writer writer, final EvaluationContextImpl context) throws IOException {
        String result = "";
        if (value != null) {
            result = HstURLHelper.INSTANCE.actionURL(value);
        }
        writer.write(result);
