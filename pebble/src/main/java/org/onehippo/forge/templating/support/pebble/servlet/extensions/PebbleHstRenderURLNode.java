...
public class PebbleHstRenderURLNode implements RenderableNode {
    private static final Logger log = LoggerFactory.getLogger(PebbleHstRenderURLNode.class);
    private final int lineNumber;
    private final String value;



    public PebbleHstRenderURLNode(final int lineNumber, final String value) {
    ...
    public void render(final PebbleTemplateImpl self, final Writer writer, final EvaluationContextImpl context) throws IOException {
        String result = "";
        if (value != null) {
            result = HstURLHelper.INSTANCE.renderURL(value);
        }
        writer.write(result);
