...
public class PebbleHstResourceURLTag implements TokenParser {

    private static final Logger log = LoggerFactory.getLogger(PebbleHstResourceURLTag.class);

    @Override
    public String getTag() {
        return "hstResourceURL";
    }
    ...
    public RenderableNode parse(final Token token, final Parser parser) {
        ...
        if (parsedExpression instanceof LiteralStringExpression) {
            ...
            return new PebbleHstResourceURLNode(lineNumber, literalStringExpression.getValue(),"");
        }
        else  {
            ...
            return new PebbleHstResourceURLNode(lineNumber,"", "");
