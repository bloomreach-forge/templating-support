...
@HippoEssentialsGenerated(internalName = "templatingsupportdemo:contentdocument")
@Node(jcrType = "templatingsupportdemo:contentdocument")
public class ContentDocument extends BaseDocument {
    ...
    public String getIntroduction() {
        return getProperty("templatingsupportdemo:introduction");
    }
    ...
    public Calendar getPublicationDate() {
        return getProperty("templatingsupportdemo:publicationdate");
    }
}
