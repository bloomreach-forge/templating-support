...
@HippoEssentialsGenerated(internalName = "templatingsupportdemo:account")
@Node(jcrType = "templatingsupportdemo:account")
public class Account extends HippoCompound {

    public static final String TYPE = "templatingsupportdemo:type";
